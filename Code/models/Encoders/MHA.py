...
class MHA_Encoder(nn.Module):
    def __init__(self, config, vocab):
        ...
        self.MHA = nn.MultiheadAttention(self.hidden_dim, self.head_num, dropout=config.dropout_p, kdim=self.embedding_dim, vdim=self.embedding_dim)
...
class MHA_User_Encoder(nn.Module):
    def __init__(self, config):
        ...
        self.MHA = nn.MultiheadAttention(self.hidden_dim, self.head_num, dropout=config.dropout_p)
        self.keyProject = nn.Linear(self.hidden_dim, self.query_dim)
