...
hparam_list = ["name", "scale", "batch_size", "his_size", "impr_size", "world_size", "signal_length", "hidden_dim", "k", "threshold", "step", "lr", "bert_lr", "diversify", "no_dedup", "word_level", "ascend_history"]
