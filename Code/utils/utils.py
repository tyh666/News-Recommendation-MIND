...
class DeDuplicate(object):
    ...
    def __init__(self, manager) -> None:
        ...
        if not manager.no_rm_punc:
            punc_map = {
                'bert':set([102,999,1001,1002,1003,1004,1006,1007,1008,1009,1010,1011,1012,1013,1024,1025,1026,1027,1028,1029,1030,1031,1032,1033,1034,1035,1036,1066,1529]),
